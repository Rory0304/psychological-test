...
const psyAnswerSheetSlice = createSlice({
    ...
    reducers: {
        ...
        setUserAnswer(state, action: PayloadAction<{ qitemNo: number; answer: string }>) {
...
export const { setAnswerSheet, setUserAnswer, resetUserAnswer } = psyAnswerSheetSlice.actions;
